...
#define VT_LOG_MAX_TID_SYSTEM_BUF_SIZE      8
#define VT_LOG_MAX_IDENT_BUF_SIZE           256
#define VT_LOG_MAX_DIR_BUF_SIZE             (62 * 1024)
#define VT_LOG_MAX_PREFIX_BUF_SIZE          1024
#define VT_LOG_MAX_SUFFIX_BUF_SIZE          64
#define VT_LOG_MAX_ROTATION_TIME_BUF_SIZE   64
...
__BEGIN_DECLS
    ...
    **/
    ...
    typedef struct _vt_msg_filelog_init_params_t{
        ...
        char tid_system[VT_LOG_MAX_TID_SYSTEM_BUF_SIZE];
        char ident[VT_LOG_MAX_IDENT_BUF_SIZE];
        char dir[VT_LOG_MAX_DIR_BUF_SIZE];
        char prefix[VT_LOG_MAX_PREFIX_BUF_SIZE];
        char suffix[VT_LOG_MAX_SUFFIX_BUF_SIZE];
        //char rotation_mode[64];
        int rotation_mode;
        uint64_t  rotation_size;
        char rotation_time[VT_LOG_MAX_ROTATION_TIME_BUF_SIZE];
...
#define logInfoEnabled()        0
#define logInformationEnabled() 0
#define logNoticeEnabled()      0
#define logWarnEnabled()        0
#define logWarningEnabled()     0
#define logErrEnabled()         0
#define logErrorEnabled()       0

#define logDebug(fmt, args...)          do {} while (0)
#define logInfo(fmt, args...)           do {} while (0)
#define logInformation(fmt, args...)    do {} while (0)

#define logNotice(fmt, args...)         do {} while (0)

#define logWarn(fmt, args...)           do {} while (0)

#define logWarning(fmt, args...)        do {} while (0)

#define logErr(fmt, args...)            do {} while (0)

#define logError(fmt, args...)          do {} while (0)

#define logCrit(fmt, args...)           do {} while (0)
#define logCritical(fmt, args...)       do {} while (0)
#define logAlert(fmt, args...)          do {} while (0)
#define logEmerg(fmt, args...)          do {} while (0)
#define logEmergence(fmt, args...)      do {} while (0)
