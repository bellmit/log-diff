...
REM
:next2
if exist %VTDM_FILEPATH2% goto next3
echo
...
set VTDM_CHECKSUM_ALGORITHM_TAG=--checksum_algorithm
set VTDM_MAX_CHUNK_SIZE_TAG=--max_chunk_size
...
set VTDM_FPARAMS=%VTDM_FPARAMS% %VTDM_CHECKSUM_ALGORITHM_TAG% %VTDM_CHECKSUM_ALGORITHM%
set VTDM_FPARAMS=%VTDM_FPARAMS% %VTDM_MAX_CHUNK_SIZE_TAG% %VTDM_MAX_CHUNK_SIZE%
...
REM
REM
set THE_CMD=%THIS_PARENT_DIRPATH%\bin\vtdiffrun
REM
REM
%THE_CMD% %VTDM_LPARAMS% %VTDM_FLAG% %VTDM_FPARAMS%
if not %errorlevel%==0 goto onerror
if exist %VTDM_DELTA_FILEPATH% goto onfilegenerated
echo
echo The command execute successful.
